...
public class BoardLikeController {
    ...
    public ResponseEntity<ApiResponse<String>> toggleBoardLike(@PathVariable Long boardId, @PathVariable Long userId, HttpServletRequest request) {
        return boardLikeService.toggleBoardLike(boardId, userId, request);
    }
